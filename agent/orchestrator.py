...
from agent.event_types import AgentEvent, AgentEventType
from agent.session_manager import Session
from client.api_response_types import StreamEventType, TokenUsage, ToolCall, ToolResultMessage
from config.configuration import Config
from prompts.system_prompts import create_loop_breaker_prompt
...
class Agent:
    def __init__(
        ...
        self.config = config
        self.session: Optional[Session] = Session(self.config)
