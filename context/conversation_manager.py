...
from client.api_response_types import TokenUsage
...
class MessageItem:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        # Always include content for assistant messages with tool_calls
        # or when content exists. API requires content field when tool_calls present.
        if self.content or self.tool_calls or self.role == "tool":
